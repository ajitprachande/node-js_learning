...
`res`     The response that you'll eventually send to the client.
...
---
Now suppose you don't want middleware to run for every route.
You want it only for specific routes.
